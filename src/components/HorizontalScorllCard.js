...
const HorizontalScorllCard = ({data = [], heading, trending, media_type}) => {
  ...
  return (
        <div className='container mx-auto px-10 my-10'>
            ...
            <div className='relative'>
                <div ref={containerRef}className='grid grid-cols-[repeat(auto-fit,250px)] grid-flow-col gap-5 overflow-hidden  overflow-x-scroll relative z-10 scroll-smooth transition-all scrolbar-none'>
                    {
                        data.map((data,index)=> {
                            return (
...
export default HorizontalScorllCard